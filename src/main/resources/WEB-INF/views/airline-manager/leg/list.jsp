...
<acme:list>
	<acme:list-column code ="airline-manager.leg.list.label.departure" path ="departure" width="30%"/>
	<acme:list-column code ="airline-manager.leg.list.label.arrival" path ="arrival" width="30%"/>
