...
<acme:menu-bar>
	<acme:menu-left>
		...
		<acme:menu-option code="master.menu.manager.flights" access="hasRealm('AirlineManager')">
			<acme:menu-suboption code="master.menu.manager.flights.flights-list" action="/manager/flight/list"/>
		</acme:menu-option>
