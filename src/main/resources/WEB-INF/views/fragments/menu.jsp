...
<acme:menu-bar>
	<acme:menu-left>
		...
		<acme:menu-option code="master.menu.flightcrewmember" access="hasRealm('FlightCrewMember')">
			...
			<acme:menu-suboption code="master.menu.flightcrewmember.flightassignments.flightAssignments-list-planned" action="/flight-crew-member/flight-assignment/list-planned"/>s
		</acme:menu-option>
